...
window.onload = async function () {
  ...
  try {
    if (typeof msal === "undefined") {
      loginMessage.textContent = "Microsoft login library is niet geladen.";
    ...
    console.error(error);
    loginMessage.textContent = "Er is een fout met Entra ID. Open F12 Console.";
    loginMessage.style.color = "red";
  }
};
...
function signInWithMicrosoft() {
  ...
  if (!msalInstance) {
    loginMessage.textContent = "Login is nog niet klaar. Refresh de pagina.";
    loginMessage.style.color = "red";
    return;
  }
